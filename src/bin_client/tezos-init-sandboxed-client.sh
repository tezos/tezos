...
activate_alpha() {
    ...
    ${client} \
        -block genesis \
        activate protocol PsCDPuxXX2c5ohGfrw1dpyCG56niUh8VG3iA6aGZMwtvWD1CvsK \
        with fitness 1 \
        and key activator \
...
alias tezos-activate-alpha="$client  -block genesis activate protocol PsCDPuxXX2c5ohGfrw1dpyCG56niUh8VG3iA6aGZMwtvWD1CvsK with fitness 1 and key activator and parameters $parameters_file --timestamp $(TZ='AAA+1' date +%FT%TZ)" ;
