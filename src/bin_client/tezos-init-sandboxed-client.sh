...
activate_alpha() {
    ...
    ${client} \
        -block genesis \
        activate protocol Pt3hpMpRjmr9cgoEjoYBHohKiYEEJmePNZF4Y5oFUowto9z6yfF \
        with fitness 1 \
        and key activator \
...
alias tezos-activate-alpha="$client  -block genesis activate protocol Pt3hpMpRjmr9cgoEjoYBHohKiYEEJmePNZF4Y5oFUowto9z6yfF with fitness 1 and key activator and parameters $parameters_file --timestamp $(TZ='AAA+1' date +%FT%TZ)" ;
